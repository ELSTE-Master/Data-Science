...
A [histogram]{.mark} can be seen as a simple [estimator of the underlying probability distribution]{.mark} of the variable:
...
In *Seaborn*, **Histograms** can be plotted using [`sns.histplots()`](https://seaborn.pydata.org/generated/seaborn.histplot.html), and (@fig-sns-hist) show the [number of times a specific Zr concentration occurs]{.mark} in the dataset.
