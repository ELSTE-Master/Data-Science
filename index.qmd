...
- Please make sure you have your [ISIS login and password]{.bg} to login
- Follow [this tutorial](appendices/setup_vscode.qmd) to [setup VSCode]{.bg} on PCs of the computer lab

Alternatively, if you want to use Python on your own computer:

- Make sure you installed an **environment manager** (e.g. [Miniconda](https://www.anaconda.com/docs/getting-started/miniconda/main)) and created a dedicated environment with the following packages installed: `pandas`, `numpy`, `jupyterlab`
- Make sure you installed VS Code and:
  - the Python extensions following [this tutorial](appendices/setup_vscode.qmd)
...
- **Simon Thivet** (UNIGE / [Physical Volcanology and Geological Risk](https://www.unige.ch/sciences/terre/en/groups/physical-volcanology-and-geological-risk/staff/))
- **Filippo Salmaso** (UNIGE / [Data Analytics Lab](https://farma-unites.unige.ch/en/data-analytics-lab/members))

The course also benefited from contributions from:

- **Lionel Voirol** (UNIGE / [Data Analytics Lab](https://farma-unites.unige.ch/en/data-analytics-lab/members))
- **Charline Lormand** (UNIGE / [MAGE](https://www.unige.ch/sciences/terre/en/groups/petrology-and-volcanology/staff/))
- **Martin Miranda Muruzabal** (UNIGE / [MAGE](https://www.unige.ch/sciences/terre/en/groups/petrology-and-volcanology/staff/))
