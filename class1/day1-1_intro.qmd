...
- {{< fa file-pdf >}} [PDF](class_1_slides_intro.pdf)
- <i class="fa fa-window-restore"></i> <a href="../slides/class1_intro.html" target="_blank">View in browser</a>

### Intro to Pandas

- {{< fa file-pdf >}} [PDF](class_1_slides_pandas.pdf)
